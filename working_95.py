...
def convert_pdf_to_images(pdf_path, output_folder, zoom=5.0, quality=100, max_dim=2000):
    ...
    for page_num in range(len(doc)):
        ...
        # Save image as JPEG with improved quality
        image_path = os.path.join(output_folder, f"{page_num + 1}.jpeg")
